...
{
    public sealed class OutputRight : FieldExtensionBase<IGaugeField>, IDataFieldExtension, IGaugeFieldExtension
    {
        private bool shakeItWindPluginLoaded = true;

        public OutputRight(string gameName) : base(gameName)
        {
            Data = new GaugeField()
            {
                Name = "WR",
        ...
        public string Description => "ShakeIt Wind output right side.";
        ...
        public void Update(PluginManager pluginManager, ref GameData data)
        {
            ...
            var objectOutput = pluginManager.GetPropertyValue("ShakeItWindPlugin.OutputRight");
